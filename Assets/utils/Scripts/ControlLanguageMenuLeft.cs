...
public class ControlLanguageMenuLeft : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        else if (PlayerPrefs.GetInt("ShowLanguageMenu") == 1)
        {
            ...
            mg_LanguagePenel.GetComponent<RectTransform>().localPosition = new Vector3(25f, -50f, 0);
        ...
        else if (PlayerPrefs.GetInt("ShowLanguageMenu") == 0)
        {
            ...
            mg_LanguagePenel.GetComponent<RectTransform>().localPosition = new Vector3(25f, 200f, 0);
